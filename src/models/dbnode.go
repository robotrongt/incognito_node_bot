...
func (db *DBnode) GetFionaText() string {
	m := map[string]string{
		...
		"2020-12-17": "-7 (-5)",
		"2020-12-18": "E' finita!!!!",
		"2020-12-19": "😂😂 A sorpresa sono spariti!",
		"2020-12-20": "😂😂 Un uccellino su un grosso ramo ha sentito dire che non li vediamo più!!",
		"2020-12-21": "Ditemi che non è vero! 😂😂",
		"2020-12-22": "Non sarà mica che oggi ci sono? 😂😂 Addio Olindo e Rosa, Shrek e Fiona.",
		"2020-12-23": "Ma veramente? Non ci sono neanche oggi? 😂😂",
		"2020-12-24": "Boom! Buon natale a tutti!",
		"2020-12-25": "Il Natale è più bello senza qualcuno? 😂😂",
		"2020-12-26": "ma non erano in ferie?",
		"2020-12-27": "sono ancora qui? 😂",
		"2020-12-28": "mi spiace non averli potuto salutare, ma sarebbe stata una gran pena, grazie di averla risparmiata!",
		"2020-12-29": "Addio Olindo e Rosa!",
		"2020-12-30": "Addio Shrek e Fiona.",
